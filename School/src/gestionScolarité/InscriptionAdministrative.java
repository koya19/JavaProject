...
public class InscriptionAdministrative {
	...
	public void setFormation() {
		...
		try {
			...
			sc.nextLine();
			if (i == 1) {
				System.out.println("Veuillez préciser votre filière");
				String s = sc.next();
	...
	public void confirmer() {
		...
		if (i == 1) {
			...
			e = new Etudiant (nom, prenom, dN.getYear(), dN.getMonth(), dN.getDate(),mail, telephone, CNE, 1, filière);
			e.afficherEtudiant();
			quitter();
		}
		else if (i == 2) {
	...
	public void setFilière() {
		System.out.println("Entrez votre filière :");
